...
const Dashboard = () => {
  ...
  // Fetch user role and data from API
  useEffect(() => {
      ...
      try {
        ...
        if (doctorsResponse.ok) {
          ...
          setDashboardCounts((prev) => ({
            ...
            appointments: 12, // Mock data - would come from appointments API
            totalPatients: 156, // Mock data - would come from patients API
            completedSessions: 89, // Mock data - would come from sessions API
          }));
        }
      } catch (err) {
    ...
    <>
      ...
      <li>
        ...
        >
          ...
          <span className="md:inline">My Patients</span>
        </NavLink>
      </li>
      <li>
        <NavLink
